...
def face_recognition(request):
    ...
    #group_id = face_compare.testCompare(group_img_url, object_to_compare_url)
    #customer = Customer.objects.get(id=customer_id)
    #group  = Group.objects.get(id=group_id) 
    #object_url = customer.object_img_url
    person = Customer.objects.get(object_img_url='https://team3-cctv-bucket.s3.us-west-2.amazonaws.com/cctv/2/2021129_18:26_object1.jpeg')
